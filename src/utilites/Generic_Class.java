...
//all of the generic method in here
	...
	public void frame(String framelocator,String inputlocator,String inputvalue,String textlocator) {
		try {
			...
			driver.findElement(By.xpath(inputlocator)).sendKeys(inputvalue);//xpath2=child frame //val=child frame value	
	...
	//-----Thia is for MOUSEHOVER-----
		...
		public static void datePicker(String framelocator,String inputlocator,String calenderlocator,String rowlocator,String collocator,String value) {
			try {
				//wait.until(ExpectedConditions.elementToBeClickable(By.xpath(framelocator)));
